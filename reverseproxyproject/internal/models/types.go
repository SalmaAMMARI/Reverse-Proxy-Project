...
// SetWeight sets the weight for weighted load balancing
...
// GetWeight returns the backend's weight (defaults to 1)
...
// GetID returns a unique identifier for the backend
...
type ServerPool struct {
	// Backends is the list of all backend servers
...
// GetBackendByURL finds a backend by its URL
...
// Count returns the number of backends in the pool
...
// CountAlive returns the number of alive backends
...
// LoadBalancer interface defines the methods for load balancing
